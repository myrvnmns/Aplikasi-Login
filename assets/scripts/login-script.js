...
/* Membuat variabel untuk penyimpan informasi email dan password. */
const expectedEmail = 'admin@dicoding.com';
const expectedPassword = 'superpassword';

/* Menambakahkan aksi klik pada button. */
loginFormElement.addEventListener('submit', function(event) {
    ...
    /* Memastikan bahwa nilai email dan password sesuai dengan nilai yang di simpan. */
